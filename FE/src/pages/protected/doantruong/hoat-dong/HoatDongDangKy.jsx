    ...
    <div className="hd-container">
      ...
      <div className="hd-stats">
        <div className="hd-stat-item">
          ...
          <span className="hd-stat-item__value">{MOCK_DANG_KY_HOAT_DONG.length}</span>
        </div>
        <div className="hd-stat-item" style={{ borderLeft: '3px solid #15803d' }}>
          <span className="hd-stat-item__label">Đã duyệt</span>
          <span className="hd-stat-item__value">{MOCK_DANG_KY_HOAT_DONG.filter(r=>r.trangThaiDuyet==='Đã duyệt').length}</span>
        </div>
        <div className="hd-stat-item" style={{ borderLeft: '3px solid #b45309' }}>
          <span className="hd-stat-item__label">Chờ duyệt</span>
          <span className="hd-stat-item__value">{MOCK_DANG_KY_HOAT_DONG.filter(r=>r.trangThaiDuyet==='Chờ duyệt').length}</span>
        </div>
