...
const SoDoanCreateModal = ({ isOpen, onClose, onCreate }) => {
  ...
  const [ngayCap, setNgayCap] = useState(new Date().toISOString().split("T")[0]);
      ...
      >
        ...
        <div className="modal-body" style={{ padding: '10px 0' }}>
          <div className="form-group" style={{ marginBottom: '15px' }}>
            <label style={{ display: 'block', marginBottom: '8px', fontWeight: 600, color: '#475569' }}>Mã sinh viên (Đoàn viên)</label>
          ...
          {student && (
            <>
              <div className="form-group" style={{ marginBottom: '15px' }}>
                <label style={{ display: 'block', marginBottom: '8px', fontWeight: 600, color: '#475569' }}>Ngày cấp sổ</label>
                <input
                  type="date"
                  value={ngayCap}
              ...
              <div className="form-group" style={{ marginBottom: '15px' }}>
                <label style={{ display: 'block', marginBottom: '8px', fontWeight: 600, color: '#475569' }}>Nơi cấp sổ</label>
                <input
                  type="text"
                  value={noiCap}
                  onChange={(e) => setNoiCap(e.target.value)}
                  placeholder="Ví dụ: Đoàn trường cấp"
                  style={{
                    width: "100%",
                    padding: "10px",
                    borderRadius: "6px",
        ...
        <div style={{ 
          ...
          <button 
            ...
            style={{
              ...
              borderRadius: "6px",
              border: "none",
              background: student ? "#004f9f" : "#94a3b8",
              color: "#fff",
