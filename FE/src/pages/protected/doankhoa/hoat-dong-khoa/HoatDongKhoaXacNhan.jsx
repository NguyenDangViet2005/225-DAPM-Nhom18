    ...
    <div className="hdk-container">
      ...
      <div className="hdk-header">
        ...
        <div className="hdk-actions">
          <button className="hdk-btn" style={{ borderColor: '#004f9f', color: '#004f9f' }}>
            <FileCheck size={18} />
            Báo cáo tổng kết
          </button>
        </div>
      ...
      <div className="hdk-stats">
        ...
        <div className="hdk-stat-item" style={{ borderLeftColor: '#004f9f' }}>
          ...
          <span className="hdk-stat-item__value">{ACTIVITY_STATS_KHOA.tongDoanVienThamGia}</span>
        </div>
        <div className="hdk-stat-item" style={{ borderLeftColor: '#475569' }}>
          <span className="hdk-stat-item__label">Đã kết thúc</span>
          <span className="hdk-stat-item__value">{ACTIVITY_STATS_KHOA.daKetThuc} hoạt động</span>
        </div>
      </div>
              ...
              return (
                <tr key={hd.idHD}>
                  <td>
                    ...
                    <span className={`hdk-badge ${hd.trangThaiHD === 'Đang diễn ra' ? 'hdk-badge--ongoing' : 'hdk-badge--ended'}`}
                  ...
                  <td>
                    <div style={{ display: 'flex', gap: '8px' }}>
                      ...
                      <button
                        ...
                        onClick={() => alert(`Đã xác nhận hoàn thành & cấp ${hd.diemHD} điểm cho "${hd.tenHD}"`)}
                      >
