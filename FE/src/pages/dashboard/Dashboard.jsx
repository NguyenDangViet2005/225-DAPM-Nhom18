...
const Dashboard = () => {
  ...
  // 📝 Lấy data mock dựa trên role của user
  // Nếu chưa có user (do AuthProvider bị tắt), ta dùng Role mặc định là DOANTRUONG để dev
  const activeRole = user?.role || 'DOANTRUONG';
