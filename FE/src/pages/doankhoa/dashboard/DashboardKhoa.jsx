        ...
        <header className="dashboard-header">
          <div className="dashboard-header__greeting">
            <h2 className="dashboard-header__title">
              Chào mừng, {(user?.name || 'Bí thư Liên chi đoàn').split(' ').pop()}
            </h2>
            ...
            <div key={i} className="stat-card">
              <div className="stat-card__top">
                ...
                <span
                  ...
                  style={{ color: stat.color, backgroundColor: `${stat.color}12` }}
                >
                  {stat.trend}
                </span>
              </div>
        ...
        <section className="dashboard-content-grid">
          ...
          <div className="dashboard-card">
            <div className="dashboard-card__header">
              <h3 className="dashboard-card__title">Đoàn viên mới đăng ký (Khoa)</h3>
          ...
          <div className="dashboard-card">
            ...
            <button className="dashboard-report-btn">Báo cáo thống kê khoa</button>
          </div>
